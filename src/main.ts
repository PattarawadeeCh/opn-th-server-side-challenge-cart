...
class Cart {
    ...
    applyDiscount(discountName: string, discountType: 'fixed' | 'percentage', amount: number, maxDiscount?: number): void {
    ...
    applyFreebie(productId: number, freebieProductId: number, quantity: number = 1): void {
